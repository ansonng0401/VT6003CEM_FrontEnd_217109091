...
class RegistrationForm extends React.Component {
  ...
  const {confirm,...data } = values;  // ignore the 'confirm' value
    ...
    fetch('https://backend.ansonng0401.repl.co/api/v1/users', {
        method: "POST",
 ...
 else
 {
    return (
      <Form {...formItemLayout} name="register" scrollToFirstError onFinish={this.onFinish}>
         ...
         <Form.Item name="firstname" label="FirstName" rules={usernameRules}>
            <Input />
        </Form.Item>
              <Form.Item name="lastname" label="LastName" rules={usernameRules}>
            <Input />
        </Form.Item>
        ...
        <Form.Item name="confirm" label="Confirm Password" rules={confirmRules} >
            ...
            <Form.Item name="role" label="Role" rules={usernameRules}>
            <Input />
        </Form.Item>
